              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">OTP-Locker-RPi</h1>
                    <h3 class="h6 text-gray-700">Enter email address to continue</h3>
                  </div>
                  <form class="user" method="post" action="process_login.php">
                    ...
                    <div class="form-group" style="display: none;">
                      ...
                      <?php if($error==1){ ?>
                      <label class="text-danger">No matching email found</label>
                      <?php } ?>
